...
const InstancesDashboard = lazy(() => import('./components/dashboard/InstancesDashboard').then(m => ({ default: m.InstancesDashboard })));
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="monitoring" element={<Suspense fallback={<PageLoader />}><InstancesDashboard /></Suspense>} />
