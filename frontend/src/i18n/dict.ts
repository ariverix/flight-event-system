...
const EDITOR_RU = {
  ...
  dashHomeTitle:          'Панель управления',
  dashStatTotalSeq:       'Всего сценариев',
  dashSubTotalSeq:        'последовательностей в системе',
  dashStatActiveSeq:      'Активных сценариев',
  dashSubOfTotalSuffix:   'всего',
  dashStatExecToday:      'Выполнений сегодня',
  dashRunningNowSuffix:   'выполняется сейчас',
  dashSubExecTodayDefault: 'за текущие сутки',
  dashStatSuccessRate:    'Процент успеха',
  dashSubNoCompleted:     'нет завершённых выполнений',
  dashSuccessfulSuffix:   'успешных',
  dashQuickActionsTitle:  'Быстрые действия',
  dashQaCreateSeqLabel:   'Создать последовательность',
  dashQaCreateSeqDesc:    'Новая ECA-последовательность',
  dashQaMonitorLabel:     'Монитор выполнений',
  dashQaMonitorDesc:      'Просмотр активных экземпляров',
  dashQaMessagesLabel:    'Журнал сообщений',
  dashQaMessagesDesc:     'История входящих сообщений',
  dashQaSimulatorLabel:   'Симулятор',
  dashQaSimulatorDesc:    'Отправить тестовое событие',
  dashQaDemoLabel:        'Демонстрация',
  dashQaDemoDesc:         'Автоматический показ сценариев',
  dashRecentExecTitle:    'Последние выполнения',
  dashAllExecLink:        'Все выполнения →',
  dashRecentExecEmpty:    'Выполнений ещё не было',
  dashSystemStatusTitle:  'Статус системы',
  dashSvcAppServer:       'Сервер приложений',
  dashSvcAppServerStatus: 'Онлайн',
  dashSvcDatabase:        'База данных',
  dashSvcDatabaseStatus:  'Подключена',
  dashSvcRulesEngine:     'Движок правил',
  dashSvcRulesEngineStatus: 'Активен',
  dashSvcOutbox:          'Outbox-публикация',
...
const EDITOR_EN = {
  ...
  // ── Dashboard (главная страница) ────────────────────────────────────────────
  dashHomeTitle:          'Dashboard',
  dashStatTotalSeq:       'Total sequences',
  dashSubTotalSeq:        'sequences in the system',
  dashStatActiveSeq:      'Active sequences',
  dashSubOfTotalSuffix:   'total',
  dashStatExecToday:      'Executions today',
  dashRunningNowSuffix:   'running now',
  dashSubExecTodayDefault: 'over the current day',
  dashStatSuccessRate:    'Success rate',
  dashSubNoCompleted:     'no completed executions',
  dashSuccessfulSuffix:   'successful',
  dashQuickActionsTitle:  'Quick actions',
  dashQaCreateSeqLabel:   'Create sequence',
  dashQaCreateSeqDesc:    'New ECA sequence',
  dashQaMonitorLabel:     'Execution monitor',
  dashQaMonitorDesc:      'View active instances',
  dashQaMessagesLabel:    'Message log',
  dashQaMessagesDesc:     'Incoming message history',
  dashQaSimulatorLabel:   'Simulator',
  dashQaSimulatorDesc:    'Send a test event',
  dashQaDemoLabel:        'Demo',
  dashQaDemoDesc:         'Automatic scenario walkthrough',
  dashRecentExecTitle:    'Recent executions',
  dashAllExecLink:        'All executions →',
  dashRecentExecEmpty:    'No executions yet',
  dashSystemStatusTitle:  'System status',
  dashSvcAppServer:       'Application server',
  dashSvcAppServerStatus: 'Online',
  dashSvcDatabase:        'Database',
  dashSvcDatabaseStatus:  'Connected',
  dashSvcRulesEngine:     'Rules engine',
  dashSvcRulesEngineStatus: 'Active',
