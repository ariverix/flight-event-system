...
const EDITOR_RU = {
  ...
  // ── SequenceForm ─────────────────────────────────────────────────────────────
  seqFormTitleCreate:   'Создать последовательность',
  seqFormTitleEdit:     'Редактировать последовательность',
  seqFormSubmitSave:    'Сохранить последовательность',
  seqFormNameLabel:     'Название последовательности',
  seqFormNameRequired:  'Введите название',
  seqFormNamePlaceholder: 'Например: Мониторинг полёта AFL123',
  seqFormDescRequired:  'Введите описание',
  seqFormDescPlaceholder: 'Краткое описание назначения последовательности',
  seqFormStartCriteriaLabel: 'Критерий запуска (JSON)',
  seqFormStopCriteriaLabel:  'Критерий остановки (JSON)',
  seqFormBackBtn:       'Назад',
  seqFormStepsCardTitle: 'Шаги последовательности',
  seqFormVisualSchemaCardTitle: 'Визуальная схема',
  seqFormEditStepModalTitle: 'Редактировать шаг',
  seqFormConfigCol:     'Конфигурация',
  seqFormOnSuccessCol:  'При успехе',
  seqFormOnFailureCol:  'При ошибке',
  seqFormMoveUpTooltip:   'Переместить вверх',
  seqFormMoveDownTooltip: 'Переместить вниз',
  seqFormLoadError:         'Ошибка загрузки последовательности',
  seqFormUpdateSuccess:     'Последовательность обновлена',
  seqFormCreateSuccess:     'Последовательность создана',
  seqFormSaveError:         'Ошибка сохранения',
  seqFormStepUpdateSuccess: 'Шаг обновлён',
  seqFormStepAddSuccess:    'Шаг добавлен',
  seqFormStepSaveError:     'Ошибка сохранения шага',
  seqFormReorderError:      'Ошибка изменения порядка шагов',
...
const EDITOR_EN = {
  ...
  // ── SequenceForm ─────────────────────────────────────────────────────────────
  seqFormTitleCreate:   'Create Sequence',
  seqFormTitleEdit:     'Edit Sequence',
  seqFormSubmitSave:    'Save Sequence',
  seqFormNameLabel:     'Sequence name',
  seqFormNameRequired:  'Enter a name',
  seqFormNamePlaceholder: 'e.g. AFL123 flight monitoring',
  seqFormDescRequired:  'Enter a description',
  seqFormDescPlaceholder: 'Brief description of the sequence purpose',
  seqFormStartCriteriaLabel: 'Start criteria (JSON)',
  seqFormStopCriteriaLabel:  'Stop criteria (JSON)',
  seqFormBackBtn:       'Back',
  seqFormStepsCardTitle: 'Sequence steps',
  seqFormVisualSchemaCardTitle: 'Visual diagram',
  seqFormEditStepModalTitle: 'Edit step',
  seqFormConfigCol:     'Configuration',
  seqFormOnSuccessCol:  'On success',
  seqFormOnFailureCol:  'On failure',
  seqFormMoveUpTooltip:   'Move up',
  seqFormMoveDownTooltip: 'Move down',
  seqFormLoadError:         'Failed to load sequence',
  seqFormUpdateSuccess:     'Sequence updated',
  seqFormCreateSuccess:     'Sequence created',
  seqFormSaveError:         'Failed to save',
  seqFormStepUpdateSuccess: 'Step updated',
  seqFormStepAddSuccess:    'Step added',
  seqFormStepSaveError:     'Failed to save step',
